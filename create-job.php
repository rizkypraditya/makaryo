...
<div class="clearfix"></div>
			...
			<div class="detail-desc section">
				...
				<div class="container">
					<form id="createjob" action="action.php" method="post" enctype='multipart/form-data'>
						...
						<!-- <form> -->
							...
							<div class="col-md-5 col-sm-6">
								<div class="input-group">
									...
									<input type="file" file accept="image/*" name="photo" required class="form-control" placeholder="Company Photo">
								</div>	
							</div>
							<div class="col-md-1 col-sm-6"></div>
							<div class="col-md-5 col-sm-6">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="email" required placeholder="Company Email">
								</div>	
							</div>
							<div class="col-md-1 col-sm-6"></div>
							<div class="col-md-5 col-sm-6">
						...
						<!-- <form> -->
							...
							<div class="col-md-5 col-sm-6">
								<div class="input-group">
									...
									<input type="text" class="form-control" placeholder="Google Hangout" name="hangout" required >
							...
							<div class="col-md-2 col-sm-6">
								<div class="input-group">
									...
									<input type="text" id="date-start" name="date_start" data-lang="en" data-large-mode="true" data-min-year="2017" data-max-year="2020" data-disabled-days="08/17/2017,08/18/2017" data-id="datedropper-0" data-theme="my-style" class="form-control" readonly="">
								</div>	
							</div>
							...
							<div class="col-md-2 col-sm-6">
								<div class="input-group">
									...
									<input type="text" id="date-end" name="date_end" data-lang="en" data-large-mode="true" data-min-year="2017" data-max-year="2020" data-disabled-days="08/17/2017,08/18/2017" data-id="datedropper-0" data-theme="my-style" class="form-control" readonly="">
								</div>	
							</div>
						<!-- </form> -->
					</div>
					...
					<div class="row bottom-mrg extra-mrg">
						<!-- <form> -->
							...
							<div class="col-md-2 col-sm-6">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-envelope"></i></span>
									<input type="text" class="form-control" placeholder="Minimum Age" name="age_min" required >
								</div>	
							</div>
							<div class="col-md-1 col-sm-6"> <div class="input-group">
									<span class="input-group-addon">to</span>
							...
							<div class="col-md-2 col-sm-6">
								<div class="input-group">
									...
									<input type="text" class="form-control" placeholder="Maximum Age" name="age_max" required >
								</div>	
							</div>
							<div class="col-md-1 col-sm-6"></div>
							<div class="col-md-5 col-sm-6">
					...
					<div class="row bottom-mrg extra-mrg">
						<!-- <form> -->
							...
							<div class="col-md-11 col-sm-11">
								<textarea class="form-control textarea" placeholder="About Company" name="description"></textarea>
								<input type="hidden" name="action" size="50" value="createjob" />
